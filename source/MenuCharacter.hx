...
class MenuCharacter extends FlxSprite
{
	private static var settings:Map<String, CharacterSetting> = [
		...
		'robosniper' => new CharacterSetting( -15, 130, 0.9),
		'THEHAT' => new CharacterSetting(-70, -225, 1.5, true)
	];
	...
	public function new(x:Int, y:Int, scale:Float, flipped:Bool)
	{
		...
		animation.addByPrefix('robosniper', "robosniper_idle", 24, false);
		animation.addByPrefix('THEHAT', "the_hat", 24, false);
